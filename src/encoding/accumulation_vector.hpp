...
/**
 * A an accumulation vector comprises an accumulation value and a sparse vector.
...
public:
    ...
    accumulation_vector(const std::vector<T> &v) : first(T::zero()), rest(v) {};
...
#include "encoding/accumulation_vector.tcc"
